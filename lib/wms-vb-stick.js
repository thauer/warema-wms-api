...
function privateStickSendMsg( stickObj, wmsCmd ){
	...
	var stickObjName = ">>>"; // stickObj.name
	log.D( "WMS-SND " + stickObjName + ": "+ wmsCmd.stickCmd.cmd );
	log.D( "MSG-SND " + stickObjName + ": "+ 	wmsCmd.msgType+" "+wmsCmd.snr+" "+JSON.stringify(wmsCmd.params) );
...
function privateOnWmsMsgRcv( stickObj, wmsMsg ){
	logger.silly( "WMS-RCV <<< " + wmsMsg.stickCmd );
	logger.silly( "MSG-RCV <<< " + JSON.stringify( wmsMsg ) );
	...
	if( ( stickObj.currentWmsMsg != undefined ) && 
		...
		privateUpdateWmsComStatistics( stickObj, wmsMsg.snr, "wmsReceived" );
		...
		if( wmsMsg.msgType === "weatherBroadcast" ){
			...
			stickObj.weather.temperature   = wmsMsg.params.temperature;
			stickObj.weather.wind   = wmsMsg.params.wind;
			stickObj.weather.illuminance  = wmsMsg.params.illuminance;
...
class WmsVbStick {
  ...
  constructor( name, channel, panid, key, optionsPar, callback, comDataSendCallback ){
	...
	// ~ ~ method ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ 
	/**
	 * Function that the antenna uses to handle a single, raw data message
	 * 
	 * @param {*} data 
	 */
	comDataReceive( data ){
		logger.silly("comDataReceive(" + data + ")")
		privateOnWmsMsgRcv( this, wmsUtil.decodeStickCmd( data ) );
	};
	
	// ~ ~ method ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ 
	initWmsNetwork(){
        logger.debug("initWmsNetwork()")
		// . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
